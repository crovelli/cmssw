...
//class LowPtGsfElectronIDExtraProducer : public edm::stream::EDProducer< edm::GlobalCache<lowptgsfeleidextra::HeavyObjectCache> > {
 ...
 public:
  ...
  static std::unique_ptr<lowptgsfeleidextra::HeavyObjectCache> 
    initializeGlobalCache( const edm::ParameterSet& conf ) {
      //return std::make_unique<lowptgsfeleidextra::HeavyObjectCache>(lowptgsfeleidextra::HeavyObjectCache(conf));
    return std::make_unique<lowptgsfeleidextra::HeavyObjectCache>(conf);  // chiara
  }
